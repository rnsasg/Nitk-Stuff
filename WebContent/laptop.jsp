    ...
    <div class="container">
		<div class="row">
			...
			<ul class="nav nav-pills nav-stacked ">
  				...
  				<li class="nav-item"><a class="nav-link" href="notes.jsp">PROJECT</a></li>
			</ul>
                ...
                <div class="col-md-3">
                    <div class="thumbnail">
                        ...
                        <%
                            ...
                            fout.close();
                        %>
			<img src="File_upload\book\<%=pic%>.jpg" alt="<%=rs.getString(5)%>" src="">
                            <div class="caption">
				 <a href="./productview.jsp?table=laptop&id=<%=rs.getInt(1)%>" ><%= rs.getString(5)%></a>
                            </div>
                    </div>
		</div>
